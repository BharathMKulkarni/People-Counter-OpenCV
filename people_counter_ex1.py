...
prototxt = os.path.join("mobilenet_ssd/MobileNetSSD_deploy.prototxt")
model = os.path.join("mobilenet_ssd/MobileNetSSD_deploy.caffemodel")
input_file = os.path.join("videos/example_01.mp4")
# input_file=""
output_file = os.path.join("output/output_01.avi")
skip_frames = 30
min_confidence = 0.4
...
while True:
	...
	frame = vs.read()
	frame = frame[1] if input_file is None else frame
